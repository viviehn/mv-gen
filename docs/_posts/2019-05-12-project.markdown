...
<figcaption>Spliced together music video generated by our system.<br> You can see the original music video for reference here. <br>The network only ever sees the audio as input at look-up time.</figcaption>
</center>
